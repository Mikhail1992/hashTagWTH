...
function isBadHashTag(tag) {
	...
	case 'тцнемига3':
	case 'моднаяодежда':
	case 'сладостиназаказ':
	case 'красивыеногти':
	case 'фотографминск':
	case 'завтраквминске':
	case 'подаркиручнойработы':
	case 'волосыминск':
	case 'котятаминск':
	case 'обувьминск':
	case 'флористика':
	...
	case 'сувениры':
	case 'мужскаякуртка':
	case 'авторскаяработа':
	case 'студияминск':
	case 'подарочныенаборыминск':
	case 'тцсилуэт':
	case 'обучениеминск':
	case 'фруктовыйбукет':
	case 'парикмахерминск':
	case 'подарокродителямминск':
	case 'неувядающиецветыминск':
	case 'серьги':
	case 'депиляциявоском':
	case 'кодовыйзамок':
	case 'ручнаяработа':
	case 'сумкиминск':
	case 'пальтоминск':
